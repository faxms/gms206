...
public class MapleRing implements Serializable {
    ...
    public static void addToDB(int itemid, MapleCharacter chr, int id, int id2) {
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseConnection.getConnection();
    ...
    public static int[] makeRing(int itemid, MapleCharacter partner1, MapleCharacter partner2) { //return partner1 the id
