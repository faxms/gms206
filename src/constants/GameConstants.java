...
public class GameConstants {
    ...
    static {
        dList.add(new Pair("mirrorD_322_0_", "상점 :: 모든 상점은 여기에 있습니다만"));
        dList.add(new Pair("mirrorD_322_1_", "이동 :: 사냥터로 이동할 수 있다."));
        dList.add(new Pair("mirrorD_322_2_", "컨텐츠 :: 컨텐츠라고 좋아하면 안되는 EU"));
        dList.add(new Pair("mirrorD_322_3_", "기능 :: 기능이라고 별건 없네요"));


         /* 데일리 기프트 */
        dailyItems.add(new DailyGiftItemInfo(1, 2450064, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(2, 5062010, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(3, 5062500, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(4, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(5, 2450064, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(6, 4310261, 300, 0));
        dailyItems.add(new DailyGiftItemInfo(7, 3994385, 1, 0));

        dailyItems.add(new DailyGiftItemInfo(8, 5062010, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(9, 5062500, 50, 0));
        dailyItems.add(new DailyGiftItemInfo(10, 4310905, 1, 0));
        dailyItems.add(new DailyGiftItemInfo(11, 2450064, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(12, 4310261, 500, 0));
        dailyItems.add(new DailyGiftItemInfo(13, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(14, 2450064, 1, 0));

        dailyItems.add(new DailyGiftItemInfo(15, 4310905, 1, 0));
        dailyItems.add(new DailyGiftItemInfo(16, 2450064, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(17, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(18, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(19, 4310261, 500, 0));
        dailyItems.add(new DailyGiftItemInfo(20, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(21, 2450134, 2, 0));

        dailyItems.add(new DailyGiftItemInfo(22, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(23, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(24, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(25, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(26, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(27, 2450134, 2, 0));
        dailyItems.add(new DailyGiftItemInfo(28, 4310911, 1, 0));
...
//            case 21121013:
    ...
    public static MapleInventoryType getInventoryType(final int itemId) {
        ...
        if (type == 1) {
            if (ii.getEquipStats(itemId).get("cash") != null) {
                type = 6;
            }
        }
        if (type < 1 || type > 6) {
    ...
    public static boolean isMagician(final int job) {
        if (GameConstants.isDefaultMagician(job) || GameConstants.isFPMage(job) || GameConstants.isILMage(job) || GameConstants.isBishop(job) || GameConstants.isFlameWizard(job) || GameConstants.isEvan(job) || GameConstants.isLuminous(job) || GameConstants.isBattleMage(job) || GameConstants.isKinesis(job) || GameConstants.isIllium(job)) {
            return true;
        }
        return false;
    }
