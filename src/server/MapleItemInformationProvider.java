...
//                                return null; //펑
                        ...
                        switch (scrollId.getItemId()) {
                            ...
                            case 2046340: // 8樂 악세서리 공격력 주문서 20%
                                nEquip.setWatk((short) (nEquip.getWatk() + Randomizer.rand(15, 25)));
                                break;
                            case 2046341: // 8樂 악세서리 마력 주문서 20%
                                nEquip.setMatk((short) (nEquip.getMatk() + Randomizer.rand(15, 25)));
                                break;
                            ...
                            case 2048048: //프리미엄 펫장비 마력 주문서 100%
                                ...
                                break;
                            case 2046831: // 홍보 악공
                                nEquip.setWatk((short) (nEquip.getWatk() + Randomizer.rand(5, 6)));
                                break;
                            case 2046832: // 홍보 악마
                                nEquip.setMatk((short) (nEquip.getMatk() + Randomizer.rand(5, 6)));
                                break;
                            case 2046981: // 홍보 무기한손
                                ...
                                nEquip.setWatk((short) (nEquip.getWatk() + 11));
                                break;
...
//                                    return null; //펑
                            ...
                            if (nEquip.getStr() > 0) {
                                int rand = Randomizer.nextInt(z) * (a ? 1 : Randomizer.nextBoolean() ? 1 : -1);
                            ...
                            if (nEquip.getHp() > 0) {
                                int rand = Randomizer.nextInt(z) * (a ? 1 : Randomizer.nextBoolean() ? 1 : -1) * 30;
