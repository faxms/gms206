        ...
        if (stats == null) {
            ...
            switch (mid) {
                ...
                case 9306000:
                    ...
                    break;
                case 8642104:
                    stats.setHp(1100000000000L);
                    break;
                case 8642103:
                    stats.setHp(1300000000000L);
                    break;
                case 8880405:
                ...
                case 8900100: // 노말 피에르
                    ...
                    break;
                case 8900000: // 칸스 피에르
                    stats.setHp(250000000000L);
                    break;
                case 8920000: // 칸스 블러드 퀸
                    stats.setHp(180000000000L);
                    break;
                case 8950100: // 노말 스우 1 페이지
                    stats.setHp(790000000000L);
                    break;
                case 8950101: // 노말 스우 2 페이지
                    stats.setHp(1410000000000L);
                    break;
                ...
                case 8880150: // 노말 루시드 2 페이지
                    stats.setHp(6800000000000L);
                    break;
                case 8880141: // 하드 루시드 1 페이지
                    stats.setHp(80800000000000L);
                    break;
                ...
                case 8880340: // 노말 윌 1 페이지
                    stats.setHp(15700000000000L);
                    break;
                case 8880341: // 노말 윌 2 페이지
                    stats.setHp(27500000000000L);
                    break;
                case 8880342: // 노말 윌 3 페이지
                    stats.setHp(46900000000000L);
                    break;
                case 8800200: // 라바나
                ...
                case 8880300: // 하드 윌 1 페이지
                    stats.setHp(152000000000000L);
                    break;
                case 8880301: // 하드 윌 2 페이지
                    stats.setHp(250500000000000L);
                    break;
                case 8880302: // 하드 윌 3 페이지
                    stats.setHp(302500000000000L);
                    break;
                case 9101078: // 불꽃 늑대
                ...
                case 8644655: // 카오스 더스크
                    stats.setHp(1001155000000000000L);
                    break;
                case 8644612: // 더스크 수하
                    stats.setHp(1000000000L);
                    break;
                ...
                case 8880501: // 파괴의 얄다바오트
                    stats.setHp(300000000000000000L);
                    break;
                ...
                case 8880502: // 검은마법사 2 페이지
                    stats.setHp(900000000000000L);
                    break;
                case 8880503: // 검은마법사 3 페이지
                    stats.setHp(82000000000000L);
                    break;
                case 8880504: // 검은마법사 4 페이지
                    stats.setHp(53000000000000L);
                    break;
                ...
                default:
                    stats.setHp(GameConstants.getPartyPlayHP(mid) > 0 ? GameConstants.getPartyPlayHP(mid) : monsterInfoData.getChildByPath("finalmaxHP") != null ? MapleDataTool.getIntConvert("maxHP", monsterInfoData) + MapleDataTool.getLongConvert("finalmaxHP", monsterInfoData, 0) : MapleDataTool.getLongConvert("maxHP", monsterInfoData));
                    break;
            }
