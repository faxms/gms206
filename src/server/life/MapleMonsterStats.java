...
public class MapleMonsterStats {
    ...
    private long hp, exp;
    private int id, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed, HpLinkMob;
    private boolean mobZone, boss, undead, firstAttack, isExplosiveReward, mobile, fly, onlyNormalAttack, friendly, noDoom, invincible, partyBonusMob, changeable, escort, publicReward;
    ...
    private List<MobSkill> skills = new ArrayList<MobSkill>();
    ...
    public void addSkeleton(String key, Integer mid, Integer value) {
        this.skeleton.add(new Triple<String, Integer, Integer>(key, mid, value));
    }
