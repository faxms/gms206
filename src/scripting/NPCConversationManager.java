...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public boolean setZodiacGrade(int grade) {
        ...
        c.getPlayer().getMap().broadcastGMMessage(c.getPlayer(), SLFCGPacket.ZodiacRankInfo(c.getPlayer().getId(), grade), true);
        c.getSession().writeAndFlush(SLFCGPacket.playSE("Sound/MiniGame.img/Result_Yut"));
        c.getSession().writeAndFlush(CField.EffectPacket.showEffect(c.getPlayer(), "Effect/CharacterEff.img/gloryonGradeup"));
        return true;
    }
