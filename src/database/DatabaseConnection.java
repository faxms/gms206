...
public class DatabaseConnection {
    ...
    public synchronized static void init() {
        ...
        try {
            ...
            // added
            String jdbcUrl = "jdbc:mariadb://localhost:3306/kms2?autoReconnect=true&characterEncoding=euckr&maxReconnects=100&CgonnectionTimeout=30000";
    ...
    public static void setConnectionPool(GenericObjectPool connectionPool) {
