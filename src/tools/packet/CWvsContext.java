...
public class CWvsContext {
    ...
    public static class BuffPacket {
        ...
        public static byte[] giveBuff(Map<MapleBuffStat, Pair<Integer, Integer>> statups, MapleStatEffect effect, MapleCharacter chr) {
          ...
          /*  if(GameConstants.isEvan(chr.getJob())){
            ...
            if (statups.containsKey(MapleBuffStat.BonusAttack)) { // 위치 불확실
                mplew.writeInt(0);
            }

            if (chr.getBuffedEffect(MapleBuffStat.EnergyCharged) != null) {
                mplew.writeInt(chr.energyCharge ? chr.getBuffedEffect(MapleBuffStat.EnergyCharged).getSourceId() : 0);
            } else {
                mplew.writeInt(0);
            }
            ...
            for (Pair<MapleBuffStat, Pair<Integer, Integer>> stat : newstatups) {
                if (!stat.left.canStack() && stat.left.isSpecialBuff()) {
                    ...
                    } else if (stat.left == MapleBuffStat.EnergyCharged) {
            ...
            if (statups.containsKey(MapleBuffStat.CriticalGrowing)) { // 위치 변경됨?
            ...
            if (statups.containsKey(MapleBuffStat.PickPocket)) {
                mplew.writeInt(chr.getPickPocket()); // 307++
            }
            ...
            if (statups.containsKey(MapleBuffStat.DemonFrenzy)) {
                mplew.write(effect.getLevel()); // 10
            }
            ...
            if (statups.containsKey(MapleBuffStat.UnkBuffStat58)) {
                mplew.writeInt(chr.getId());
                mplew.writeInt(1);
            }
            ...
            if (statups.containsKey(MapleBuffStat.getByFlag(0x27A))) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.getByFlag(0x27B))) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.getByFlag(0x27E))) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.getByFlag(0x280))) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.getByFlag(0x284))) {
                mplew.writeInt(0);
            }
            if (statups.containsKey(MapleBuffStat.getByFlag(0x285))) {
                mplew.writeInt(0);
                mplew.writeInt(0);
            }
            ...
            //    System.out.println("givebuf"+mplew.toString());
            //mplew.writeInt(0); //Prevent for Err code 38 : end of file
            return mplew.getPacket();
        }
        ...
        public static byte[] giveForeignBuff(MapleCharacter chr, Map<MapleBuffStat, Pair<Integer, Integer>> statups, MapleStatEffect effect) {
            ...
            mplew.writeShort(0);
            mplew.write(statups.containsKey(MapleBuffStat.BlessedHammer) || statups.containsKey(MapleBuffStat.IceAura)); // onoff?

        /*    mplew.writeLong(0); // Prevent For Err code 38 : End of FIle.
            mplew.writeLong(0); // Prevent For Err code 38 : End of FIle.
            mplew.writeLong(0); // Prevent For Err code 38 : End of FIle.
            mplew.writeLong(0); // Prevent For Err code 38 : End of FIle.*/
            return mplew.getPacket();
    ...
    public static class InfoPacket {
        ...
        public static byte[] GainEXP_Monster(MapleCharacter chr, final long gain, final boolean white, long flag, int eventBonusExp, int weddingExp, int partyExp, int itemEquipExp, int pcExp, int rainbowWeekExp, int boomupExp, int portionExp, int skillExp, int buffExp, int restExp, int itemExp, int valueExp, int bonusExp, int bloodExp, int iceExp, Pair<Integer, Integer> burningExp, int hpLiskExp, int fieldBonusExp, int eventBonusExp2, int fieldBonusExp2) {
            ...
            if ((flag & 0x20) != 0) {
                packet.writeInt(partyExp); // 파티 보너스
            }
            if ((flag & 0x40) != 0) {
            ...
            if ((flag & 0x800) != 0) {
                packet.writeInt(skillExp); // null 추가 보너스 (스킬이름 삘)
            }
            if ((flag & 0x1000) != 0) {
    ...
    public static class GuildPacket {
        ...
        public static byte[] changeCustomGuildEmblem(MapleCharacter chr, byte[] imgdata) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] useNoblessSkill(int skid) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0xA9);
            mplew.writeInt(0);
        ...
        public static byte[] guildInvite(int gid, String guildname, MapleCharacter chr) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0x6E); //343 +5
            mplew.writeInt(gid);
        ...
        public static byte[] requestGuild(MapleGuild g, final MapleCharacter chr) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] getGuildInfo(MapleGuild g) { // 1.2.343 K
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0x3F);
            mplew.writeInt(g.getId());
        ...
        public static void getGuildInfo(MaplePacketLittleEndianWriter mplew, MapleGuild guild) { // 1.2.329 OK
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                mplew.writeInt(guild.getRankRole(i)); // 1.2.329++ (길드 역할)
            }
        ...
        public static byte[] newGuildMember(MapleGuildCharacter mgc) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0x4E); //343 +5
        ...
        public static byte[] addRegisterRequest(MapleGuildCharacter mgc) { // 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0x57);  //+5
            mplew.writeInt(mgc.getGuildId());
        ...
        public static byte[] RequestDeny(MapleCharacter chr) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] DelayRequest() { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] memberLeft(MapleGuildCharacter mgc, boolean bExpelled) {// 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(bExpelled ? 0x5F : 0x62); // +2
            mplew.writeInt(mgc.getGuildId());
            mplew.writeInt(mgc.getId());
        ...
        public static byte[] guildDisband(int gid) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] guildCapacityChange(int gid, int capacity) { // 1.2.329 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

            mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
            mplew.write(0x71);
            mplew.writeInt(gid);
            mplew.write(capacity); // write

            return mplew.getPacket();
        }

        public static byte[] guildMemberLevelJobUpdate(MapleGuildCharacter mgc) { // 1.2.343
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] rankTitleChange(MapleCharacter chr, String[] ranks, int[] roles) { // 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] changeRank(MapleGuildCharacter mgc) { // 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] guildContribution(int gid, int cid, int c) { // 1.2.343
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] updateGP(int gid, int GP, int glevel) { // 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        public static byte[] guildNotice(MapleCharacter chr, String notice) { // 1.2.343 OK
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        mplew.write(0); // update
    ...
    public static byte[] PsychicDamage(LittleEndianAccessor slea, final MapleClient c) {
        ...
        if (slea.available() >= 2) {
            packet.writeInt((int) slea.readShort());
        }
