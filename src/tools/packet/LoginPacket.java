...
public class LoginPacket {
    ...
    public static byte[] getServerHello(short mapleVersion, final byte[] sendIv, final byte[] recvIv) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(15);
        mplew.writeShort(0x123);
        mplew.writeInt((int) ServerConstants.MAPLE_VERSION);
        mplew.write(recvIv);
        mplew.write(sendIv);
        mplew.write(1);
...
//        mplew.write(HexTool.getByteArrayFromHexString("0D 00 00 00 73 F8 FA D9 C3 DD CB DD C4 C8 00 00 00"));
    ...
    public static byte[] ChannelBackImg(boolean isSunday) {
        ...
        if (isSunday) {
            ...
            mplew.writeMapleAsciiString("2020Neo_3rd");
        }
        mplew.writeInt(1);
        mplew.writeInt(0);
        mplew.write(0);
